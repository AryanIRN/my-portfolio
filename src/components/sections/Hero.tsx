  ...
  return (
    <section className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container px-4 md:px-6 z-10 text-center select-none">
        ...
        >
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tighter text-white uppercase italic leading-none w-full break-words">            <span onMouseEnter={scrambleFirst} className="cursor-default inline-block">{firstName}</span>
            <br />
            <span
